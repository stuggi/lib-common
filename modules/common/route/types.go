...
type OverrideSpec struct {
	...
	*EmbeddedLabelsAnnotations `json:"metadata,omitempty" protobuf:"bytes,1,opt,name=metadata"`
	...
	//   - Parameters which are a struct have to be overridded by providing the full struct if
	//     they contain required parameters. Required parameters of sub structs have to be named.
