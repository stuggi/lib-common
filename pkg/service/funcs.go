...
func (s *Service) CreateOrPatch(
	...
	op, err := controllerutil.CreateOrPatch(ctx, h.GetClient(), service, func() error {
		service.Labels = common.MergeStringMaps(service.Labels, s.service.Labels)
...
// DeleteWithLabel - Delete all services in namespace of the obj matching label selector
func DeleteWithLabel(
	ctx context.Context,
	h *helper.Helper,
	obj metav1.Object,
